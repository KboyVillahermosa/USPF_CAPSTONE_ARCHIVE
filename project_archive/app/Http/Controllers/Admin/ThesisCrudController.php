...
class ThesisCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/thesis');
        CRUD::setEntityNameStrings('thesis', 'theses');
        
        // Only show entries with type 'thesis'
        $this->crud->addClause('where', 'type', 'thesis');
    }
    ...
    {
        CRUD::setValidation(ThesisRequest::class);

        CRUD::field('title');
        CRUD::field('author');
        CRUD::field('type')->type('hidden')->value('thesis'); // Set type automatically
